...
unsigned const char symbol[97][8] =
{
     ...
     { 0x30,0x7A,0x4F,0x5D,0x37,0x72,0x50,0x00 },
     { 0x00,0x00,0x00,0x07,0x07,0x00,0x00,0x00 },
     { 0x00,0x00,0x00,0x3E,0x7F,0x63,0x41,0x00 },
     { 0x00,0x41,0x63,0x7F,0x3E,0x00,0x00,0x00 },
     ...
     { 0x00,0x21,0x61,0x45,0x4F,0x7B,0x31,0x00 },
     { 0x00,0x18,0x1C,0x16,0x7F,0x7F,0x10,0x00 },
     { 0x00,0x27,0x67,0x45,0x45,0x7D,0x39,0x00 },
     { 0x00,0x3E,0x7F,0x49,0x49,0x79,0x30,0x00 },
     ...
     { 0x00,0x3E,0x7F,0x41,0x5D,0x57,0x5E,0x00 },
     ...
     { 0x00,0x3E,0x7F,0x51,0x21,0x7F,0x5E,0x00 },
     ...
     { 0x00,0x80,0x80,0xFD,0x7D,0x00,0x00,0x00 },
     ...
     { 0x00,0x38,0x7C,0x44,0x44,0xFC,0xFC,0x00 },
     ...
     { 0x0C,0x06,0x06,0x0C,0x18,0x18,0x0C,0x00 },
     { 0x00,0x60,0x78,0x5E,0x46,0x58,0x60,0x00 }
};
# 6 "main.c" 2
...
void main(void) {
    ...
    MAX7219_Init(n_matrices);

    while(1){

        for(i = 33; i<= 58; i++){
            for(int j=1; j<8; j++){
                MAX7219_Tx(j, symbol[i][j-1], 0);
            }
