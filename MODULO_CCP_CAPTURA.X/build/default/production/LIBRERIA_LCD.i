...
void LCD_XY(unsigned char row, unsigned char column);
...
void LCD_Init(void){
    ...
    TRISDbits.RD7=0;
    LATDbits.LATD0=0;
    _delay((unsigned long)((15)*(4000000L/4000.0)));

    enviar_dato(0x30);
    _delay((unsigned long)((5)*(4000000L/4000.0)));
    enviar_dato(0x30);
    _delay((unsigned long)((100)*(4000000L/4000000.0)));
    enviar_dato(0x32);
    _delay((unsigned long)((100)*(4000000L/4000000.0)));
...
void enviar_dato(unsigned char cmd){
    ...
    LATDbits.LATD4=(cmd>>4)&0x01;
    LATDbits.LATD5=(cmd>>5)&0x01;
    LATDbits.LATD6=(cmd>>6)&0x01;
    LATDbits.LATD7=(cmd>>7)&0x01;

    LATDbits.LATD1=1;
    _delay((unsigned long)((100)*(4000000L/4000000.0)));
    LATDbits.LATD1=0;

    LATDbits.LATD4= cmd&0x01;
    LATDbits.LATD5=(cmd&0x0F)>>1;
    LATDbits.LATD6=(cmd&0x0F)>>2;
    LATDbits.LATD7=(cmd&0x0F)>>3;
